    ...
    public abstract partial class LocaleData
    {
        ...
        protected Dictionary<string, string> msgFallback
            = new Dictionary<string, string>()
            {
                ...
                ["GuiMainDetUptime"] = "Up",
                ["GuiWpfRowFootprint"] = "StarMon",
                ["GuiWpfFootprintCommitted"] = "committed",
                ["GuiMainDetPlan"] = "Plan",
                ["GuiMainDetLoad"] = "Load",
                ["GuiMainDetVram"] = "VRAM",
                ["GuiMainDetSsd"] = "SSD",
                ...
                ["GuiTipFootprint"] = "What StarMon itself is costing: the memory actually resident, which is what the task manager shows, and the memory committed to it, which is the figure that grows if something is leaking. This is a WPF application, and once this window has been opened its visual tree stays resident.",
