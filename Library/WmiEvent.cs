        ...
        public WmiEvent() {
            if(!this.IsInitialized) {
                try {
                    ...
                    Logger.Error("WmiEvent", "CIM session setup failed", e.Message);
                }
            }
        }
...
#region Creation
        ...
        public bool CreateBinding(CimInstance consumer, CimInstance filter) {
            if(!this.IsInitialized || consumer == null || filter == null)
                return false;
            try {
                ...
                Logger.Error("WmiEvent", "Creating an event binding failed", e.Message);
                return false;
            }
        }
        ...
        public CimInstance CreateInstance(string className, Dictionary<string, object> args) {
            ...
            try {
                ...
                Logger.Error("WmiEvent", "Creating " + className + " failed", e.Message);
            }
            return null;
        }
#endregion
