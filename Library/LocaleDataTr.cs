    ...
    public abstract partial class LocaleData
    {
        ...
        protected Dictionary<string, string> msgTurkish
            = new Dictionary<string, string>()
            {
                ...
                ["GuiWpfFootprintCommitted"] = "ayrılmış",
                ["GuiMainDetPlan"] = "Plan",
                ["GuiMainDetLoad"] = "Yük",
                ["GuiMainDetVram"] = "VRAM",
                ["GuiMainDetSsd"] = "SSD",
                ...
                ["GuiTipFootprint"] = "StarMon'un kendisine mal olduğu: fiilen bellekte duran miktar — görev yöneticisinin gösterdiği budur — ve kendisine ayrılmış miktar; bir sızıntı varsa büyüyen rakam ikincisidir. Bu bir WPF uygulamasıdır ve bu pencere bir kez açıldıktan sonra görsel ağacı bellekte kalır.",
